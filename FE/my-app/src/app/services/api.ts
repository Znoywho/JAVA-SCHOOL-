...
function normalizeProduct(raw: any): Product {
  return {
    ...
    frameSize: raw.frameSize ?? raw.FrameSize ?? raw.frame_size ?? undefined,
    wheelSize: raw.wheelSize ?? raw.WheelSize ?? raw.wheel_size ?? undefined,
    isVerified: raw.isVerified ?? raw.verified ?? raw.is_verified ?? false,
    minRiderHeight: raw.minRiderHeight ?? raw.MinRiderHeight ?? raw.min_rider_height ?? undefined,
    maxRiderHeight: raw.maxRiderHeight ?? raw.MaxRiderHeight ?? raw.max_rider_height ?? undefined,
    maxWeightCapacityKg: raw.maxWeightCapacityKg ?? raw.MaxWeightCapacityKg ?? raw.max_weight_capacity_kg ?? undefined,
    weightKg: raw.weightKg ?? raw.WeightKg ?? raw.weight_kg ?? undefined,
